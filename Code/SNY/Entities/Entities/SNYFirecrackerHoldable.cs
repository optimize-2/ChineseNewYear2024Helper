...
namespace Celeste.Mod.ChineseNewYear2024Helper.SNY.Entities.Entities {
    [Tracked]
    [CustomEntity("ChineseNewYear2024Helper/SNYFireCrackerHoldable")]
	public class SNYFireCrackerHoldable : Actor {
		public float BeforeLaunchTime;
		public float LaunchTime;
		public float LaunchSpeed;
		public bool Holdable;

		public SNYFireCrackerHoldable(EntityData e, Vector2 offset) : base(e.Position + offset) {
			this.BeforeLaunchTime = e.Float("beforeLaunchTime", 3f);
			this.LaunchTime = e.Float("launchTime", 5f);
			this.LaunchSpeed = e.Float("launchTime", 5f);
		...
		public override void Added(Scene scene) {
			...
			foreach (Entity entity in this.Level.Tracker.GetEntities<SNYFireCrackerHoldable>()) {
				SNYFireCrackerHoldable SNYFireCrackerHoldable = (SNYFireCrackerHoldable)entity;
				if (SNYFireCrackerHoldable != this && SNYFireCrackerHoldable.Hold.IsHeld) {
					base.RemoveSelf();
				}
			}
		}
		...
		private void ImpactParticles(Vector2 dir) {
			...
			this.Level.Particles.Emit(SNYFireCrackerHoldable.P_Impact, 12, position, positionRange, direction);
		}
